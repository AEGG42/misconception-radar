...
Recording state: collision template, eight-person synthetic class, browser at 100% zoom
...
| 0:33–0:40 | Click **Analyze class**; cut the wait cleanly | “The diagnostic engine compares each explanation with a teacher-reviewed rubric and misconception taxonomy.” |
